...
//
    ...
    override func viewDidLoad() {
        ...
        foodImg.image = UIImage(named: (ff5?.foodImg1)!)
       labelBigNameFood.text = ff5?.labelBigNameFood1
       labelTime.text = ff5?.labelTime1
       labelOtcenka.text = ff5?.labelOtcenka1
       labelCountry.text = ff5?.labelCountry1
       labelTypeFood.text = ff5?.labelTypeFood1
       labelKM.text = ff5?.labelKM1
        labelDelivery.text = ff5?.labelDelivery1
        labelPrice.text = ff5?.labelPrice1
